...
Stubs heavy / circular imports (logging, container, encryption) before any
handler/service is loaded so node tests don't pay the cost of real DI or
Temporal runtimes during collection.
"""
