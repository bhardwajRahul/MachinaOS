...
register_node(type="openaiChatModel",     metadata={"displayName": "OpenAI",      "subtitle": "Chat Model", "icon": "🤖", "color": "#00A67E", "group": ["model"], "componentKind": "model", "handles": _MODEL_OUT, "description": "OpenAI GPT models for chat completion and generation", "version": 1})
register_node(type="anthropicChatModel",  metadata={"displayName": "Claude",      "subtitle": "Chat Model", "icon": "🧠", "color": "#FF6B35", "group": ["model"], "componentKind": "model", "handles": _MODEL_OUT, "description": "Anthropic Claude models for conversation and analysis", "version": 1})
register_node(type="geminiChatModel",     metadata={"displayName": "Gemini",      "subtitle": "Chat Model", "icon": "⭐", "color": "#4285F4", "group": ["model"], "componentKind": "model", "handles": _MODEL_OUT, "description": "Google Gemini models for multimodal AI capabilities", "version": 1})
register_node(type="openrouterChatModel", metadata={"displayName": "OpenRouter",  "subtitle": "Chat Model", "icon": "🔀", "color": "#6366F1", "group": ["model"], "componentKind": "model", "handles": _MODEL_OUT, "description": "OpenRouter unified API - access OpenAI, Claude, Gemini, Llama, and more", "version": 1})
register_node(type="groqChatModel",       metadata={"displayName": "Groq",        "subtitle": "Chat Model", "icon": "⚡", "color": "#F55036", "group": ["model"], "componentKind": "model", "handles": _MODEL_OUT, "description": "Groq ultra-fast LLM inference (Llama, Qwen3, GPT-OSS)", "version": 1})
register_node(type="cerebrasChatModel",   metadata={"displayName": "Cerebras",    "subtitle": "Chat Model", "icon": "🧬", "color": "#ffb86c", "group": ["model"], "componentKind": "model", "handles": _MODEL_OUT, "description": "Cerebras ultra-fast inference on custom AI hardware", "version": 1})
register_node(type="deepseekChatModel",   metadata={"displayName": "DeepSeek",    "subtitle": "Chat Model", "icon": "🌊", "color": "#8be9fd", "group": ["model"], "componentKind": "model", "handles": _MODEL_OUT, "description": "DeepSeek V3 models (deepseek-chat, deepseek-reasoner with always-on CoT)", "version": 1})
register_node(type="kimiChatModel",       metadata={"displayName": "Kimi",        "subtitle": "Chat Model", "icon": "🌙", "color": "#bd93f9", "group": ["model"], "componentKind": "model", "handles": _MODEL_OUT, "description": "Kimi K2 models by Moonshot AI with 256K context (thinking on by default)", "version": 1})
register_node(type="mistralChatModel",    metadata={"displayName": "Mistral",     "subtitle": "Chat Model", "icon": "🌬", "color": "#ffb86c", "group": ["model"], "componentKind": "model", "handles": _MODEL_OUT, "description": "Mistral AI models for reasoning, coding, and multilingual tasks", "version": 1})
...
register_node(type="whatsappSend",   metadata={"displayName": "WhatsApp Send",  "subtitle": "Send Message",      "icon": "💬", "color": "#25D366", "group": ["whatsapp", "tool"], "componentKind": "square", "handles": _IO, "description": "Send WhatsApp messages (text, media, location, contact, sticker)", "version": 1})
register_node(type="whatsappDb",     metadata={"displayName": "WhatsApp DB",    "subtitle": "Query DB",          "icon": "🗃", "color": "#25D366", "group": ["whatsapp", "tool"], "componentKind": "square", "handles": _IO, "description": "Query WhatsApp database (chat history, contacts, groups, channels)", "version": 1})

register_node(type="telegramSend",   metadata={"displayName": "Telegram Send",  "subtitle": "Send Message",      "icon": "✈️", "color": "#0088CC", "group": ["social", "tool"], "componentKind": "square", "handles": _IO, "description": "Send text, photo, document, location, or contact via Telegram bot", "version": 1})

register_node(type="twitterSend",    metadata={"displayName": "Twitter Send",   "subtitle": "Tweet / Reply",     "icon": "🐦", "color": "#1DA1F2", "group": ["social", "tool"], "componentKind": "square", "handles": _IO, "description": "Post tweets, reply, retweet, like, or delete tweets on Twitter/X", "version": 1})
register_node(type="twitterSearch",  metadata={"displayName": "Twitter Search", "subtitle": "Search Tweets",     "icon": "🔍", "color": "#1DA1F2", "group": ["social", "tool"], "componentKind": "square", "handles": _IO, "description": "Search recent tweets on Twitter/X using the Search API", "version": 1})
register_node(type="twitterUser",    metadata={"displayName": "Twitter User",   "subtitle": "User Profiles",     "icon": "👤", "color": "#1DA1F2", "group": ["social", "tool"], "componentKind": "square", "handles": _IO, "description": "Look up Twitter/X user profiles, followers, and following", "version": 1})

register_node(type="emailSend",      metadata={"displayName": "Email Send",     "subtitle": "SMTP Outbound",     "icon": "✉️", "color": "#8be9fd", "group": ["email", "tool"], "componentKind": "square", "handles": _IO, "description": "Send emails via SMTP (Gmail, Outlook, Yahoo, iCloud, ProtonMail, Fastmail, custom)", "version": 1})
register_node(type="emailRead",      metadata={"displayName": "Email Read",     "subtitle": "IMAP Read/Manage",  "icon": "📖", "color": "#8be9fd", "group": ["email", "tool"], "componentKind": "square", "handles": _IO, "description": "Read and manage emails via IMAP - list, search, read, move, delete, flag", "version": 1})

register_node(type="chatSend",       metadata={"displayName": "Chat Send",      "subtitle": "Send to Chat",      "icon": "💬", "color": "#8be9fd", "group": ["chat"], "componentKind": "square", "handles": _IO, "description": "Send messages to chat conversations", "version": 1})
register_node(type="chatHistory",    metadata={"displayName": "Chat History",   "subtitle": "Retrieve Messages", "icon": "📜", "color": "#8be9fd", "group": ["chat"], "componentKind": "square", "handles": _IO, "description": "Retrieve chat conversation history", "version": 1})
...
register_node(type="gmail",     metadata={"displayName": "Gmail",     "subtitle": "Email Operations",   "icon": "📧", "color": "#EA4335", "group": ["google", "tool"], "componentKind": "square", "handles": _IO, "description": "Gmail send / search / read operations", "version": 1})
register_node(type="calendar",  metadata={"displayName": "Calendar",  "subtitle": "Event Management",   "icon": "📅", "color": "#4285F4", "group": ["google", "tool"], "componentKind": "square", "handles": _IO, "description": "Google Calendar create / list / update / delete events", "version": 1})
register_node(type="drive",     metadata={"displayName": "Drive",     "subtitle": "File Operations",    "icon": "📁", "color": "#0F9D58", "group": ["google", "tool"], "componentKind": "square", "handles": _IO, "description": "Google Drive upload / download / list / share files", "version": 1})
register_node(type="sheets",    metadata={"displayName": "Sheets",    "subtitle": "Spreadsheet Ops",    "icon": "📊", "color": "#0F9D58", "group": ["google", "tool"], "componentKind": "square", "handles": _IO, "description": "Google Sheets read / write / append spreadsheet data", "version": 1})
register_node(type="tasks",     metadata={"displayName": "Tasks",     "subtitle": "Task Management",    "icon": "✅", "color": "#4285F4", "group": ["google", "tool"], "componentKind": "square", "handles": _IO, "description": "Google Tasks create / list / complete / update / delete", "version": 1})
register_node(type="contacts",  metadata={"displayName": "Contacts",  "subtitle": "Contact Management", "icon": "👥", "color": "#4285F4", "group": ["google", "tool"], "componentKind": "square", "handles": _IO, "description": "Google Contacts create / list / search / get / update / delete", "version": 1})
...
register_node(type="braveSearch",      metadata={"displayName": "Brave Search",      "subtitle": "Web Search",       "icon": "🦁", "color": "#FB542B", "group": ["search", "tool"], "componentKind": "square", "handles": _IO, "description": "Search the web using Brave Search API", "version": 1})
register_node(type="serperSearch",     metadata={"displayName": "Serper Search",    "subtitle": "Google SERP",      "icon": "🔎", "color": "#ff79c6", "group": ["search", "tool"], "componentKind": "square", "handles": _IO, "description": "Search the web using Google via Serper API (web/news/images/places)", "version": 1})
register_node(type="perplexitySearch",  metadata={"displayName": "Perplexity Search","subtitle": "AI Search",        "icon": "✨", "color": "#ff79c6", "group": ["search", "tool"], "componentKind": "square", "handles": _IO, "description": "AI-powered search using Perplexity Sonar with citations", "version": 1})

register_node(type="browser",          metadata={"displayName": "Browser",          "subtitle": "Browser Automation","icon": "🌐", "color": "#ff79c6", "group": ["browser", "tool"], "componentKind": "square", "handles": _IO, "description": "Interactive browser automation via agent-browser CLI", "version": 1})
register_node(type="apifyActor",       metadata={"displayName": "Apify Actor",      "subtitle": "Web Scraper",      "icon": "🕸", "color": "#ff79c6", "group": ["api", "scraper", "tool"], "componentKind": "square", "handles": _IO, "description": "Run Apify actors for Instagram, TikTok, Twitter, LinkedIn, etc.", "version": 1})
