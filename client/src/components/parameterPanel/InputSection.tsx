      ...
      const nodeDataPromises = edgesToProcess.map(async ({ edge, label, targetHandleLabel }) => {
        ...
        if (executionData && executionData[0] && executionData[0][0]) {
          ...
          if (nodeType === 'start') {
            ...
            const aiAgentTypes = ['aiAgent', 'chatAgent', 'android_agent', 'coding_agent', 'web_agent', 'task_agent', 'social_agent', 'travel_agent', 'tool_agent', 'productivity_agent', 'payments_agent', 'consumer_agent', 'autonomous_agent', 'orchestrator_agent', 'ai_employee', 'rlm_agent', 'claude_code_agent', 'deep_agent'];
